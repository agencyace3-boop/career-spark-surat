...
const stats = [
  { icon: Users, value: "3,000+", label: "Students Trained" },
  { icon: Award, value: "95%", label: "Placement Rate" },
  { icon: Star, value: "4.9/5", label: "Student Rating" },
  { icon: BookOpen, value: "20+", label: "Expert Courses" },
];
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-primary-foreground">
            ...
            <div
              ...
              className="inline-flex items-center gap-2 bg-secondary/20 backdrop-blur-sm border border-secondary/30 rounded-full px-4 py-2 mb-6 animate-fade-in"
            >
            ...
            <p
              ...
              className="text-lg md:text-xl text-primary-foreground/90 mb-8 max-w-xl animate-fade-in-up"
            ...
            >
              <Link to="/courses">
                <Button
                  size="lg"
                  className="bg-secondary hover:bg-secondary/90 text-secondary-foreground shadow-glow animate-pulse-glow text-base px-8"
                >
                  {slide.cta}
            ...
            <div className="bg-background/10 backdrop-blur-xl rounded-3xl p-8 border border-primary-foreground/10 shadow-elevated">
              ...
              <div className="grid grid-cols-2 gap-6">
                {stats.map((stat, index) => (
                  <div
                    key={stat.label}
                    className="text-center p-4 bg-primary-foreground/5 rounded-2xl hover:bg-primary-foreground/10 transition-colors"
          ...
          {heroSlides.map((_, index) => (
            <button
              ...
              className={`relative h-2 rounded-full transition-all duration-300 overflow-hidden ${
                index === currentSlide ? "w-12 bg-secondary" : "w-8 bg-primary-foreground/30 hover:bg-primary-foreground/50"
              }`}
              aria-label={`Go to slide ${index + 1}`}
            >
              {index === currentSlide && (
                <div className="absolute inset-0 bg-secondary/50 animate-[progress_6s_linear]" />
              )}
            </button>
          ))}
        </div>
