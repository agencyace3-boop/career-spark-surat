      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl">
          ...
          <h1
            ...
            className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6 text-primary-foreground animate-fade-in-up"
          >
            {slide.headline}
            <br />
          ...
          >
            <Link to="/courses">
              <Button
                size="lg"
                className="bg-secondary hover:bg-secondary/90 text-secondary-foreground shadow-glow text-base px-8"
              >
                Explore Courses
