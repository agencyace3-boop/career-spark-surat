...
const testimonials = [
  {
    ...
    rating: 5,
    text: "Surat Digital Marketing completely transformed my career. Within 3 months of completing the course, I landed a job at a top tech company with a 150% salary increase. The hands-on training and placement support were exceptional!",
  ...
  },
  {
    ...
    rating: 5,
    text: "The SEO training at Surat Digital Marketing is unmatched. I learned advanced techniques that helped me rank websites on page 1 of Google. The trainers share real strategies that actually work in today's competitive market.",
  ...
  },
  {
    ...
    rating: 5,
    text: "I was a complete beginner when I joined Surat Digital Marketing. The structured curriculum and patient trainers helped me master social media marketing. Now I manage campaigns for national brands!",
  ...
  },
  {
    ...
    rating: 5,
    text: "Thanks to Surat Digital Marketing, I now run my own digital marketing consultancy. The agency setup training and business skills I learned here were invaluable. I earn 3x more than my previous job!",
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Join thousands of students who transformed their careers with Surat Digital Marketing. 
          ...
          <div className="relative rounded-3xl overflow-hidden shadow-elevated max-w-4xl mx-auto">
            ...
            <div className="absolute bottom-8 left-8 right-8">
              <p className="text-2xl font-bold text-primary-foreground mb-2">
                "Surat Digital Marketing Changed My Life"
              </p>
