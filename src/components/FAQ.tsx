...
const faqs = [
  ...
  },
  {
    ...
    answer: "Upon successful completion, you'll receive our industry-recognized Surat Digital Marketing certification. Additionally, we prepare you for and help you obtain certifications from Google (Google Ads, Analytics), Meta (Blueprint), HubSpot, and other industry platforms at no extra cost.",
  },
  {
  ...
  {
    question: "What makes Surat Digital Marketing different from other institutes?",
