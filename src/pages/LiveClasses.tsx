...
// Batch start date: 15th April 2026
const BATCH_START_DATE = new Date("2026-04-15T20:00:00+05:30");
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="text-foreground">
                <div className="inline-flex items-center gap-2 bg-secondary/20 backdrop-blur-sm border border-secondary/30 rounded-full px-5 py-2.5 mb-8 animate-fade-in">
                  ...
                  <span className="text-sm font-bold text-secondary"><span className="text-sm font-bold text-secondary">Fresh Batch Starting 15th April 2026!</span></span>
                </div>
                ...
                <div className="bg-card rounded-3xl p-6 md:p-8 shadow-elevated border border-secondary/30 relative overflow-hidden">
                  ...
                  <div className="bg-primary/10 border border-primary/30 rounded-xl p-4 mb-6">
                    <div className="flex items-center justify-center gap-2">
                      ...
                      <span className="font-bold text-foreground"><span className="font-bold text-foreground">Batch Starts: 15th April 2026</span></span>
                    </div>
                  </div>
